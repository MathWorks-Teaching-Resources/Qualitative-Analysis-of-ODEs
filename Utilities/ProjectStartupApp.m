classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Qualitative-Analysis-of-ODEs";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Qualitative Analysis of ODEs';
            ...
            app.Image.ImageSource = 'trdet.png';
            ...
            app.ReviewTitle.Position = [2 326 274 80];
            app.ReviewTitle.Text = 'Welcome to Qualitative Analysis of ODEs';
